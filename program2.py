...
class otp_verifier(Tk):
    def __init__(self):
        ...
        self.n = str(self.OTP())
        self.client = Client("AC50296d33a79a73c3294b264b84f28086", "88d8994f530a7b87e251bf479e95c6df")
        self.client.messages.create(to =("+918873037290"),
                      from_ ="+",
                     body = self.n)
